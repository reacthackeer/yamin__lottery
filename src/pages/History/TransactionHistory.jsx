...
import { useGetAllSingleUserTransactionHistoryQuery } from '../../Store/feature/lottery/api';
...
const TransactionHistory = () => { 
    ...
    const {data, isSuccess, isLoading, isError} = useGetAllSingleUserTransactionHistoryQuery({userId, page: currentPage, limit: currentLimit});
    useEffect(()=>{
