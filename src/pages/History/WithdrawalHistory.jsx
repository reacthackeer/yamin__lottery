...
import { useGetAllSingleUserWithdrawalHistoryQuery } from '../../Store/feature/lottery/api';
...
const TransferHistory = () => { 
    ...
    const {data, isSuccess, isLoading, isError} = useGetAllSingleUserWithdrawalHistoryQuery({userId, page: currentPage, limit: currentLimit});
    console.log(data);
    useEffect(()=>{
