...
import { useGetAllSingleUserLotteryBuyHistoryQuery } from '../../Store/feature/lottery/api';
...
const BuyingHistory = () => { 
    ...
    const {data, isSuccess, isLoading, isError} = useGetAllSingleUserLotteryBuyHistoryQuery({userId, page: currentPage, limit: currentLimit});
    useEffect(()=>{
