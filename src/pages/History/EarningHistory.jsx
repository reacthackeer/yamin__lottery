...
import { useGetAllSingleUserEarningHistoryQuery } from '../../Store/feature/lottery/api';
...
const EarningHistory = () => { 
    ...
    const {data, isSuccess, isLoading, isError} = useGetAllSingleUserEarningHistoryQuery({userId, page: currentPage, limit: currentLimit});
    useEffect(()=>{
