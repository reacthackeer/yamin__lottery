...
import { useGetAllSingleUserTransferHistoryQuery } from '../../Store/feature/lottery/api';
...
const TransferHistory = () => { 
    ...
    const {data, isSuccess, isLoading, isError} = useGetAllSingleUserTransferHistoryQuery({userId, page: currentPage, limit: currentLimit});
    console.log(data);
    useEffect(()=>{
